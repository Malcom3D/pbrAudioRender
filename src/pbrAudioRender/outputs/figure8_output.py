...
class Figure8Output(OmnidirectionalOutput):
    """Figure-8 (bidirectional) microphone output with frequency-dependent processing"""
    
    def process_audio(self) -> Dict[str, np.ndarray]:
        """
        Process audio for figure-8 microphone across all frequency bands and layers
        ...
        # Initialize frequency frequency-pressure arrays
        all_frequencies = []
        all_pressures = []
        ...
        for position in positions:
            ...
            for band_idx, (low_freq, high_freq) in enumerate(self.bands):
                ...
                if hasattr(self.output_config, 'spatial_freq_response'):
                    ...
                    figure8_signal *= magnitude_coeff
                ...
                if hasattr(self.output_config, 'calibration'):
                    ...
                    figure8_signal *= cal_coeff
                
                all_frequencies.append(center_freq)
                all_pressures.append(figure8_signal)
